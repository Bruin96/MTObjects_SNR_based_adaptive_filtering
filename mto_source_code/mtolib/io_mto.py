...
def make_parser():
    ...
    parser.add_argument('-alpha', type=float, help='significance level', default=1e-6)
    parser.add_argument('-move_factor', type=utils.validate_positive, help='Moves up the object marker', default=0.0)
    ...
    parser.add_argument('-snr', type=float, help='SNR value for adaptive filtering', default=3.0)
